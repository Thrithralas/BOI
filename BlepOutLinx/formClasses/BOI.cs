...
namespace Blep {
    ...
    public partial class BlepOut : Form {
        ...
        public BlepOut() {
            ...
            if (VoiceOfBees.ModEntryList.Count > 0) {
                VoiceOfBees.ModEntryList[0].TryDownload(ModFolder);
            }
        }
        ...
        private void label5_Click(object sender, EventArgs e) {
            string rwExePath = Directory.GetFiles(RootPath, "RainWorld.exe")[0];
            Process.Start(rwExePath);
        }
    }
}